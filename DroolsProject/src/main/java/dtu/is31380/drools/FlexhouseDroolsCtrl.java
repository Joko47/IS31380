 ...
 */
public class FlexhouseDroolsCtrl extends AbstractHouseController {

	private KieServices kieServices;
	private KieContainer kContainer;
	private StatelessKieSession kSession;
	
	  public FlexhouseDroolsCtrl() {
        ...
        try {
            // load up the knowledge base
        	 ...
        	 kSession = kContainer.newStatelessKieSession("ksession-rulesFlex");  
